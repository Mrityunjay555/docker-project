...
import OurTeamPage from "./pages/OurTeams";
import StudentHire from "./pages/StudentOrg";
import Announcement from "./pages/Announcement";
//import StudentOrg from "./pages/StudentOrg";
import Membership from "./pages/Membership";
//import CreatEvent from "./pages/CreateEvent";

axios.defaults.baseURL = "http://3.80.78.147:4000/";
    ...
    <UserContextProvider>
      <Routes>
        <Route path="/" element={<Layout />}>
          ...
          <Route path="/hire" component={Membership} />
          <Route path="/event/:id/ordersummary" element={<OrderSummary />} />
        </Route>
        {/* <Route path="/verification" element={<CreatEvent />} /> */}
